namespace PV
{
    partial class ReporteCuentasPorPagar
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.spCuentasPorPagarBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.sp_CuentasPorPagarTableAdapter = new PV.ControlCondominiosDataSet49TableAdapters.sp_CuentasPorPagarTableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.spCuentasPorPagarBindingSource)).BeginInit();
            this.SuspendLayout();
            // 
            // reportViewer1
            // 
            ...
            reportDataSource2.Value = this.spCuentasPorPagarBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "PV.ReporteCuentasPorPagar.rdlc";
            ...
            // 
            // spCuentasPorPagarBindingSource
            // 
            this.spCuentasPorPagarBindingSource.DataMember = "sp_CuentasPorPagar";
            this.spCuentasPorPagarBindingSource.DataSource = this.controlCondominiosDataSet49;
            // 
            // sp_CuentasPorPagarTableAdapter
            // 
            this.sp_CuentasPorPagarTableAdapter.ClearBeforeFill = true;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.spCuentasPorPagarBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource spCuentasPorPagarBindingSource;
        private ControlCondominiosDataSet49 controlCondominiosDataSet49;
        private ControlCondominiosDataSet49TableAdapters.sp_CuentasPorPagarTableAdapter sp_CuentasPorPagarTableAdapter;
    }
}