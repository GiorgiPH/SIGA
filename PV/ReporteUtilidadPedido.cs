...
namespace PV
{
    public partial class ReporteUtilidadPedido : Form
    {
        string fecha1 = string.Empty;
        string fecha2 = string.Empty;

        public ReporteUtilidadPedido(string fecha1, string fecha2)
        {
            InitializeComponent();
            this.fecha1 = fecha1;
            this.fecha2 = fecha2;
        ...
        private void ReporteUtilidadPedido_Load(object sender, EventArgs e)
        {
            ...
            this.sp_ReporteOrdenesPedidoUtilidadTableAdapter.Fill(this.dTSReporteOrdenesPedidoUtilidad.sp_ReporteOrdenesPedidoUtilidad, Convert.ToDateTime(this.fecha1), Convert.ToDateTime(this.fecha2), 2);
