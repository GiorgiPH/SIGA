...
namespace PV
{
    public partial class ReporteDiarioNotasCargo : Form
    {
        ...
        public ReporteDiarioNotasCargo(string Proveedor, string Fecha, string Fecha1, string Fecha2)
        {
            InitializeComponent();
            provedor = Proveedor;
            fecha = Fecha;
        ...
        private void ReporteDiarioNotasCargo_Load(object sender, EventArgs e)
        {
            ...
            {
                this.NotasGastoTableAdapter.Fill(this.ControlCondominiosDataSet37.NotasGasto);
            }
            else if (cmbPropietario1.Text != "TODOS" && cbFechas.Checked == false)
            {
                this.NotasGastoTableAdapter.FillBy(this.ControlCondominiosDataSet37.NotasGasto, cmbPropietario1.Text);
            }
            else if (cmbPropietario1.Text != "TODOS" && cbFechas.Checked == true)
            {
                this.NotasGastoTableAdapter.FillBy1(this.ControlCondominiosDataSet37.NotasGasto, cmbPropietario1.Text, dtFecha1.Text, dtFecha2.Text);
            }
            else if (cmbPropietario1.Text == "TODOS" && cbFechas.Checked == true)
            {
                this.NotasGastoTableAdapter.FillBy2(this.ControlCondominiosDataSet37.NotasGasto, dtFecha1.Text, dtFecha2.Text);
            }
