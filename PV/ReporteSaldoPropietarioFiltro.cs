...
namespace PV
{
    public partial class ReporteSaldoPropietarioFiltro : Form
    {
        ...
        public ReporteSaldoPropietarioFiltro()
        {
            InitializeComponent();
        }
        ...
        private void ReporteSaldoPropietarioFiltro_Load(object sender, EventArgs e)
        {
        ...
        {
            ReporteSaldoPropietario reporteSaldoPropietario = new ReporteSaldoPropietario(propietario1, propietario2, fecha, fecha1, fecha2, divisa, TipoCambio);
