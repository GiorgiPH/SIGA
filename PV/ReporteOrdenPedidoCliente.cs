...
namespace PV
{
    public partial class ReporteOrdenPedidoCliente : Form
    {
        ...
        public ReporteOrdenPedidoCliente(string FolioOrdenPedido, string IdCliente)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", this.controlCondominiosDataSet23.Tables[0]));

            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet2", this.controlCondominiosDataSet59.Tables[0]));
            this.reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet3", this.controlCondominiosDataSet8.Tables[0]));
