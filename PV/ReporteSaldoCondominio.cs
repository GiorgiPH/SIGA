...
namespace PV
{
    public partial class ReporteSaldoCondominio : Form
    {
        ...
        int pro1 = 0;
        public static string Propi1 = string.Empty;
        int pro2 = 0;
        public static string Propi2 = string.Empty;
        string Divisa = string.Empty;
        string TipoCambio = string.Empty;


        public ReporteSaldoCondominio(string Propietario1, string Propietario2, string Fecha, string Fecha1, string Fecha2, string divisa, string tipocambio)
        {
            InitializeComponent();
        ...
        private void ReporteSaldoCondominio_Load(object sender, EventArgs e)
        {
            ...
            // TODO: esta línea de código carga datos en la tabla 'ControlCondominiosDataSet16.Recibo' Puede moverla o quitarla según sea necesario.
            if (cmbSaldos.Text == "Si")
            {
                if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == true)
                {

                    this.ReciboTableAdapter.FillBy2(this.ControlCondominiosDataSet16.Recibo, dtFecha1.Text, dtFecha2.Text);
                ...
                else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == true)
                {
                    ...
                    this.ReciboTableAdapter.FillBy1(this.ControlCondominiosDataSet16.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2), dtFecha1.Text, dtFecha2.Text);

                    this.reportViewer1.RefreshReport();
                }
                else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == false)
                {
                    this.ReciboTableAdapter.FillBy(this.ControlCondominiosDataSet16.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2));

                    this.reportViewer1.RefreshReport();
                }
                else if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == false)
                {
                    this.ReciboTableAdapter.Fill(this.ControlCondominiosDataSet16.Recibo);
            ...
            else
            {
                if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == true)
                {
                    ...
                    this.ReciboTableAdapter.FillBy6(this.ControlCondominiosDataSet16.Recibo, dtFecha1.Text, dtFecha2.Text);
                ...
                else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == true)
                {
                    ...
                    this.ReciboTableAdapter.FillBy5(this.ControlCondominiosDataSet16.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2), dtFecha1.Text, dtFecha2.Text);

                    this.reportViewer1.RefreshReport();
                }
                else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == false)
                {
                    this.ReciboTableAdapter.FillBy4(this.ControlCondominiosDataSet16.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2));

                    this.reportViewer1.RefreshReport();
                }
                else if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == false)
                {
                    this.ReciboTableAdapter.FillBy3(this.ControlCondominiosDataSet16.Recibo);
        ...
        private void ReporteSaldoCondominio_Activated(object sender, EventArgs e)
        {
            cmbPropietario1.Text = propietario1;
            cmbpropietario2.Text = propietario2;
        ...
        private void ReporteSaldoCondominio_FormClosing(object sender, FormClosingEventArgs e)
        {
