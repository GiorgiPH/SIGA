...
namespace PV
{
    public partial class ReporteSaldoCondominioFiltro : Form
    {
        ...
        public ReporteSaldoCondominioFiltro()
        {
            InitializeComponent();
        }

        private void ReporteSaldoCondominioFiltro_Load(object sender, EventArgs e)
        {
        ...
        {
            ReporteSaldoCondominio reporteSaldoPropietario = new ReporteSaldoCondominio(propietario1, propietario2, fecha, fecha1, fecha2, divisa, TipoCambio);
