...
namespace PV
{
    public partial class ReporteEstadoCuenta : Form
    {
        ...
        public ReporteEstadoCuenta(string razonsocial, string pagos, string saldo, string fecha, string fecha1, string fecha2, int Firma, string anticipo, string propiedad)
        {
            InitializeComponent();
        ...
        private void ReporteEstadoCuenta_Load(object sender, EventArgs e)
        {
                ...
                if (Pagos == "Si")
                {
                    if (Saldo == "Si")
                    {
                        if (Fecha == "Si")
                        {
                            if (Propiedad == string.Empty)
                            {
                                this.ReciboTableAdapter.FillBy4(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Fecha1, Fecha2);
                                this.reportViewer1.RefreshReport();
                            }
                            else
                            {
                                this.ReciboTableAdapter.FillBy12(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Fecha1, Fecha2, Propiedad);
                                this.reportViewer1.RefreshReport();
                            }
                        }
                        else
                        {
                            if (Propiedad == string.Empty)
                            {
                                this.ReciboTableAdapter.FillBy3(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial));
                                this.reportViewer1.RefreshReport();
                            }
                            else
                            {
                                this.ReciboTableAdapter.FillBy11(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Propiedad);
                                this.reportViewer1.RefreshReport();
                            }
                        }
                    }
                    else
                    {
                        if (Fecha == "Si")
                        {
                            if (Propiedad == string.Empty)
                            {
                                this.ReciboTableAdapter.FillBy6(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Fecha1, Fecha2);
                                this.reportViewer1.RefreshReport();
                            }
                            else
                            {
                                this.ReciboTableAdapter.FillBy14(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Fecha1, Fecha2, Propiedad);
                                this.reportViewer1.RefreshReport();
                            }
                        }
                        else
                        {
                            if (Propiedad == string.Empty)
                            {
                                this.ReciboTableAdapter.FillBy5(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial));
                                this.reportViewer1.RefreshReport();
                            }
                            else
                            {
                                this.ReciboTableAdapter.FillBy13(this.ControlCondominiosDataSet22.Recibo, Convert.ToInt32(RazonSocial), Propiedad);
                                this.reportViewer1.RefreshReport();
                            }
                        }
                    }
        ...
        private void ReporteEstadoCuenta_Activated(object sender, EventArgs e)
        {
            NumberFormatInfo formato = new CultureInfo("US-AR").NumberFormat;
        ...
        private void ReporteEstadoCuenta_FormClosing(object sender, FormClosingEventArgs e)
        {
