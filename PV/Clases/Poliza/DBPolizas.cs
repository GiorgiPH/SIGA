...
namespace PV.Clases.Polizas
{
    class DBPolizas
    {
        ...
        public void Consultar_DefinicionesPolizaCompras(DataGridView dgv, string TipoPoliza)
        {
            try
            {
                if (TipoPoliza == "Compras")
                {
                    ...
                    dgv.Rows.Clear();
                    da = new SqlDataAdapter("select Consecutivo,Clave,Nombre from DEFPOLIZA as DP where TipoPolzOpcion='Definiciones Compras' and nombre in ('Define Póliza Compras Almacén','Define Póliza Compras Gastos')", cn);
                    dt = new DataTable();
                    da.Fill(dt);
                }
        ...
        //----------------------------- obtiene el tipo de definicion de poliza
        public void Catalogo_DefPolizaGen2(int clave, string TipoPoliza, Guna.UI2.WinForms.Guna2TextBox txtdescripcion, Guna.UI2.WinForms.Guna2TextBox Estatus, Guna.UI2.WinForms.Guna2TextBox TipoCargo1, Guna.UI2.WinForms.Guna2TextBox TipoCargo2, Guna.UI2.WinForms.Guna2TextBox TipoCargo3, Guna.UI2.WinForms.Guna2TextBox TipoCargo4, Guna.UI2.WinForms.Guna2TextBox TipoCargo5, Guna.UI2.WinForms.Guna2TextBox TipoAbono1, Guna.UI2.WinForms.Guna2TextBox TipoAbono2, Guna.UI2.WinForms.Guna2TextBox TipoAbono3, Guna.UI2.WinForms.Guna2TextBox TipoAbono4, ComboBox tipopoliza, Guna.UI2.WinForms.Guna2TextBox DiarioP, Guna.UI2.WinForms.Guna2TextBox TipoSeparador)
        {
            try
            {
        ...
        public void ConsultaDefPolizaCompras(DataGridView dgv, string TipoPoliza)
        {
            try
            {
                ...
                if (TipoPoliza == "Compras")
                {
                    ...
                    dgv.Rows.Clear();
                    da = new SqlDataAdapter("select  Consecutivo,Clave, Nombre, Estatus, TipoPoliza from DEFPOLIZA as DP where TipoPolzOpcion='Definiciones Compras' and nombre in ('Define Póliza Compras Almacén','Define Póliza Compras Gastos')", cn);
                    dt = new DataTable();
                    da.Fill(dt);
                }
                if (TipoPoliza == "Egresos")
        ...
        //-----------------------
        public void CargarInfoPoliza(string Conse, string clave, string Nombre, TextBox C1, TextBox C2, TextBox C3, TextBox C4, TextBox C5, TextBox abono1, TextBox abono2, TextBox abono3, TextBox abono4, TextBox tiposeparador, ComboBox TipoPoliza, TextBox DiarioP, string TipoPolzOpcion)
        {
            try
            {
        ...
        //----------------------------------------------------------
        public void CargarInfoPolizaGP(string Conse, string clave, string Nombre, TextBox C1, TextBox C2, TextBox C3, TextBox C4, TextBox C5, TextBox abono1, TextBox abono2, TextBox abono3, TextBox abono4, TextBox tiposeparador, ComboBox TipoPoliza, TextBox DiarioP, string TipoPolzOpcion)
        {
            try
            {
        ...
        //----------------------------------------------------------
        public void CargarInfoPolizaCompras(string Conse, string clave, string Nombre, TextBox C1, TextBox C2, TextBox C3, TextBox C4, TextBox C5, TextBox C6, TextBox C7, TextBox abono1, TextBox abono2, TextBox abono3, TextBox abono4, TextBox tiposeparador, ComboBox TipoPoliza, TextBox DiarioP, string TipoPolzOpcion)
        {
            try
            {
        ...
        //----------------------------------------------------------
        public void DescripcionDocumento(string clave, Guna.UI2.WinForms.Guna2TextBox Nombre)
        {
        ...
        //----------------------------------------------------------
        public void DescripcionDocumentoCompras(string clave, Guna.UI2.WinForms.Guna2TextBox Nombre)
        {
