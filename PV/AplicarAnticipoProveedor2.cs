...
namespace PV
{
    public partial class AplicarAnticipoProveedor2 : Form
    {
        ...
        public AplicarAnticipoProveedor2()
        {
            InitializeComponent();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            AplicarAnticipoProveedorSaldo2 cobro = new AplicarAnticipoProveedorSaldo2(Importe, txtMatricula.Text, txtAlumno.Text, Anticipo);
            cobro.ShowDialog();
        ...
        {
            // FIX: llamaba a c.CargarReciboAlumno (el método de CLIENTES, no de
            // Proveedores) — residuo de copiar el formulario de clientes para
            // hacer este de proveedores. Este botón vive en
            // AplicarAnticipoProveedor, así que debe recargar el mismo grid de
            // Anticipos de Proveedor que ya carga txtMatricula_TextChanged.
            matricula = string.Empty;
            nombre = string.Empty;
            Limpiar();
            c.CargarReciboProveedor(dgvPagosPendientes, txtMatricula.Text);
