...
{
    public partial class DocumentoConceptoGlobal : Form
    {
        DBGenerarRecibo c = new DBGenerarRecibo();
        string recibo = string.Empty;
        string reciboCol = string.Empty;

        public DocumentoConceptoGlobal(string Folio, string Recibo, string ReciboCol)
        {
            InitializeComponent();
            TxtFolio.Text = Folio;
            recibo = Recibo;
        ...
        private void DocumentoConceptoGlobal_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No es posible registrar un impuesto en el recibo");
                return;
            }
            else 
            {
