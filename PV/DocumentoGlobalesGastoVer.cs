...
namespace PV
{
    public partial class DocumentoGlobalesGastoVer : Form
    {
        DBOrdenCompra c = new DBOrdenCompra();
        public static string Concep = string.Empty;

        public DocumentoGlobalesGastoVer(string Folio)
        {
            InitializeComponent();
            TxtFolio.Text = Folio;
        }

        private void DocumentoGlobalesGastoVer_Load(object sender, EventArgs e)
        {
            c.CargarRecibosConceptoGasto(dataGridView1, TxtFolio.Text);
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                c.ConsultaConceptoGasto(TxtFolio.Text, Concepto, Total, txtCleveConcepto, txtConcepto, txtclase, txtTipo, txtDivisa, txtTipoCambio, txtSubtotal, txtDescuento, txtTotal);
