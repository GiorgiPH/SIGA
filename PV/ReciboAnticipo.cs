...
namespace PV
{
    public partial class ReciboAnticipo : Form
    {
        ...
        public ReciboAnticipo(string Folio, string opcion, string Cliente)
        {
            InitializeComponent();
            folio = Folio;
            Opcion = opcion;
        ...
        private void ReciboAnticipo_Load(object sender, EventArgs e)
        {
            ControlCondominiosDataSet50.EnforceConstraints = false;
            ...
            // TODO: esta línea de código carga datos en la tabla 'ControlCondominiosDataSet50.Anticipo' Puede moverla o quitarla según sea necesario.
            this.AnticipoTableAdapter.Fill(this.ControlCondominiosDataSet50.Anticipo, Convert.ToInt32(folio));
