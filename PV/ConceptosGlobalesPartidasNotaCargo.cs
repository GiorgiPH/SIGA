...
namespace PV
{
    public partial class ConceptosGlobalesPartidasNotaCargo : Form
    {
        DBOrdenCompra c = new DBOrdenCompra();
        string recibo = string.Empty;
        string reciboCol = string.Empty;

        public ConceptosGlobalesPartidasNotaCargo(string Folio, string Recibo, string ReciboCol)
        {
            InitializeComponent();
            TxtFolio.Text = Folio;
            recibo = Recibo;
        ...
        private void ConceptosGlobalesPartidasNotaCargo_Load(object sender, EventArgs e)
        {
            c.ConsultaNotaCargoPartida(TxtFolio.Text, txtPartida);
            c.SeleccionarConceptoGlobalesReciboNotaCargo(cmbConcepto);
        //    c.ConsultaSubtotalNotaCargo(TxtFolio.Text, txtSubtotal);
            txtDivisa.Text = "MXN";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                c.InsertarReciboConceptoGlobalNotaCargo3(txtClave.Text, TxtFolio.Text);
                if (txtclase.Text == "Cargo")
                {

                    c.InsertarReciboConceptoGlobalNotaCargo2(txtClave.Text, TxtFolio.Text, Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtDescuento.Text), Convert.ToDecimal(txtTotal.Text));
                    c.ActualizarReciboConceptoGlobalNotaCArgo(Convert.ToInt32(TxtFolio.Text), Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtTotal.Text), txtPartida.Text);
                ...
                else if (txtclase.Text == "Impuesto")
                {
                    ...
                    else
                    {
                        ...
                        c.InsertarReciboConceptoGlobalNotaCargo2(txtClave.Text, TxtFolio.Text, Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtImpuesto.Text), Convert.ToDecimal(txtTotal.Text));
                        c.ActualizarReciboConceptoGlobalNotaCargo2(Convert.ToInt32(TxtFolio.Text), Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtTotal.Text), txtPartida.Text);
                    }
                ...
                else if (txtclase.Text == "Descuento")
                {
                    ...
                    c.InsertarReciboConceptoGlobalNotaCredito(txtClave.Text, TxtFolio.Text, Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtDescuento.Text), Convert.ToDecimal(txtTotal.Text));
                    c.ActualizarReciboConceptoGlobalNotaCArgo(Convert.ToInt32(TxtFolio.Text), Convert.ToDecimal(txtSubtotal.Text), Convert.ToDecimal(txtTotal.Text), txtPartida.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                c.EliminarReciboConceptoGlobalNotaCargo3(TxtFolio.Text);
                this.Close();
            }
        }
