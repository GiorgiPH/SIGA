...
namespace PV
{
    public partial class ReporteAnticipoProveedorFiltro : Form
    {
        ...
        public ReporteAnticipoProveedorFiltro()
        {
            InitializeComponent();
        }

        private void ReporteAnticipoProveedorFiltro_Load(object sender, EventArgs e)
        {
        ...
        {
            ReporteAnticipoProveedor reporteSaldoPropietario = new ReporteAnticipoProveedor(propietario1, propietario2, fecha, fecha1, fecha2);
