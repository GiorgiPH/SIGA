...
namespace PV
{
    public partial class ReporteSaldoDetalladoFiltro : Form
    {
        ...
        public ReporteSaldoDetalladoFiltro()
        {
            InitializeComponent();
        }

        private void ReporteSaldoDetalladoFiltro_Load(object sender, EventArgs e)
        {
        ...
        {
            ReporteSaldosDetallados reporteSaldoPropietario = new ReporteSaldosDetallados(propietario1, propietario2, fecha, fecha1, fecha2, Saldados, divisa, TipoCambio);
