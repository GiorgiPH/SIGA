...
namespace PV
{
    public partial class PartidaGastoVer : Form
    {
        ...
        public PartidaGastoVer(string Folio)
        {
            InitializeComponent();
            TxtFolio.Text = Folio;
        }

        private void PartidaGastoVer_Load(object sender, EventArgs e)
        {
            c.CargarRecibosPartidasGasto(dataGridView1, TxtFolio.Text);
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
              ...
              //  c.ConsultaPartidaGasto(TxtFolio.Text, Partida, txtClaveConcepto, txtConcepto, txtConcepto2, txtCantidad, txtUnidad, txtDivisa, txtTipoCambio, txtSubtotal, txtDescuento, txtTotal, txtImpuesto, txtArchivo);
