...
namespace PV
{
    public partial class ReporteSaldosDetallados : Form
    {
        ...
        public ReporteSaldosDetallados(string Propietario1, string Propietario2, string Fecha, string Fecha1, string Fecha2, string saldados, string divisa, string tipocambio)
        {
            InitializeComponent();
        ...
        private void ReporteSaldosDetallados_Load(object sender, EventArgs e)
        {
            ...
            if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == true && cmbSaldos.Text=="Si")
            {
                ...
                this.ReciboTableAdapter.FillBy2(this.ControlCondominiosDataSet17.Recibo, dtFecha1.Text, dtFecha2.Text);
            ...
            else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == true && cmbSaldos.Text == "Si")
            {
                ...
                this.ReciboTableAdapter.FillBy1(this.ControlCondominiosDataSet17.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2), dtFecha1.Text, dtFecha2.Text);

                this.reportViewer1.RefreshReport();
            }
            else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == false && cmbSaldos.Text == "Si")
            {
                this.ReciboTableAdapter.FillBy(this.ControlCondominiosDataSet17.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2));

                this.reportViewer1.RefreshReport();
            }
            else if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == false && cmbSaldos.Text == "Si")
            {
                this.ReciboTableAdapter.Fill(this.ControlCondominiosDataSet17.Recibo);
            ...
            else if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == true && cmbSaldos.Text == "No")
            {
                ...
                this.ReciboTableAdapter.FillBy6(this.ControlCondominiosDataSet17.Recibo, dtFecha1.Text, dtFecha2.Text);
            ...
            else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == true && cmbSaldos.Text == "No")
            {
                ...
                this.ReciboTableAdapter.FillBy5(this.ControlCondominiosDataSet17.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2), dtFecha1.Text, dtFecha2.Text);

                this.reportViewer1.RefreshReport();
            }
            else if (cmbPropietario1.Text != "TODOS" && cmbpropietario2.Text != "TODOS" && cbFechas.Checked == false && cmbSaldos.Text == "No")
            {
                this.ReciboTableAdapter.FillBy4(this.ControlCondominiosDataSet17.Recibo, Convert.ToInt32(Propi1), Convert.ToInt32(Propi2));

                this.reportViewer1.RefreshReport();
            }
            else if (cmbPropietario1.Text == "TODOS" && cmbpropietario2.Text == "TODOS" && cbFechas.Checked == false && cmbSaldos.Text == "No")
            {
                this.ReciboTableAdapter.FillBy3(this.ControlCondominiosDataSet17.Recibo);
