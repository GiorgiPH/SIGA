...
namespace PV
{
    public partial class DocumentoGlobalesRecepcionVer : Form
    {
        DBOrdenCompra c = new DBOrdenCompra();
        public static string Concep = string.Empty;

        public DocumentoGlobalesRecepcionVer(string Folio)
        {
            InitializeComponent();
            TxtFolio.Text = Folio;
        }

        private void DocumentoGlobalesRecepcionVer_Load(object sender, EventArgs e)
        {
