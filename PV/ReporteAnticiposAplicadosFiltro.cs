...
namespace PV
{
    public partial class ReporteAnticiposAplicadosFiltro : Form
    {
        ...
        public ReporteAnticiposAplicadosFiltro()
        {
            InitializeComponent();
        }

        private void ReporteAnticiposAplicadosFiltro_Load(object sender, EventArgs e)
        {
        ...
        {
            ReporteAnticiposAplicados reporteSaldoPropietario = new ReporteAnticiposAplicados(propietario1, propietario2, fecha, fecha1, fecha2);
