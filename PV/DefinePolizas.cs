...
namespace PV
{
    public partial class DefinePolizas : Form
    {
        ...
        public static string CuentasPersonales = string.Empty;
        List<string> itemsDisponibles = new List<string>();
        List<string> itemsEstaticos = new List<string>();

        List<ComboBox> Cargos = new List<ComboBox>();
        List<ComboBox> Abonos = new List<ComboBox>();

        public DefinePolizas(string TipoPoliza)
        {
            InitializeComponent();
            ToolTip tt = new ToolTip();
            tt.SetToolTip(button1, "Nuevo");
            tt.SetToolTip(button4, "Consultar");
            tt.SetToolTip(button9, "Imprimir");

            TipoPolz = TipoPoliza;
             TipopolizaCompras = string.Empty;
         CuentasPersonales = string.Empty;
    }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cmbTpoliza.SelectedIndex = -1;
            txtDpoliza.Clear();
            txtCargo1.Text = string.Empty;
            cmbcargo1.Text = string.Empty;
            txtCargo2.Text = string.Empty;
            cmbcargo2.Text = string.Empty;
            txtCargo3.Text = string.Empty;
            cmbcargo3.Text = string.Empty;
            txtCargo4.Text = string.Empty;
            cmbcargo4.Text = string.Empty;
            txtCargo5.Text = string.Empty;
            cmbcargo5.Text = string.Empty;
            cmbcargo6.Text = string.Empty;

            txtAbono1.Text = string.Empty;
            cmbabono1.Text = string.Empty;
            txtAbono2.Text = string.Empty;
            cmbabono2.Text = string.Empty;
            txtAbono3.Text = string.Empty;
            cmbabono3.Text = string.Empty;
            txtAbono4.Text = string.Empty;
            cmbabono4.Text = string.Empty;
            cmbabono5.Text = string.Empty;
        ...
        private void CargarConfigPolizas()
        {
            if (TipoPolz == "Definiciones Condominios")
            {
                ...
                txtnombre.Items.Remove("Póliza Traspasos Recibo");
                ...
                txtnombre.Items.Remove("Define Póliza Compras Inventariables");
                ...
                txtnombre.Items.Remove("Define Póliza Anticipos Proveedores");
                txtnombre.Items.Remove("Define Póliza Aplicación Anticipos Proveedores");
                txtnombre.Items.Remove("Define Póliza Entradas Inventariables");
                txtnombre.Items.Remove("Define Póliza Salidas Inventariables");
                txtnombre.Items.Remove("Define Póliza Traspasos Inventariables");
            }
            ...
            if (TipoPolz == "Definiciones Gastos Personales")
            {
                ...
                txtnombre.Items.Remove("Define Póliza Ingresos Globales");
            ...
            if(TipoPolz== "Definiciones Inventarios")
            {
                //    cmbestatus.Items.Insert(0, "Activo");
                cmbestatus.SelectedIndex = 0;
                txtnombre.DropDownStyle = ComboBoxStyle.DropDownList;

                c.Catalogo_DefPolizaInventarios(TipoPolz, lblconsecutivo);
                c.Catalogo_cargosyabonosInventarios(cmbcargo1);
                c.Catalogo_cargosyabonosInventarios(cmbcargo2);
                c.Catalogo_cargosyabonosInventarios(cmbcargo3);
                c.Catalogo_cargosyabonosInventarios(cmbcargo4);
                c.Catalogo_cargosyabonosInventarios(cmbcargo5);
                c.Catalogo_cargosyabonosInventarios(cmbabono1);
                c.Catalogo_cargosyabonosInventarios(cmbabono2);
                c.Catalogo_cargosyabonosInventarios(cmbabono3);
                c.Catalogo_cargosyabonosInventarios(cmbabono4);
                txtCargo1.Enabled = false;
                txtCargo2.Enabled = false;
                txtCargo3.Enabled = false;
                txtCargo4.Enabled = false;
        ...
        private void DefinePolizas_Load(object sender, EventArgs e)
        {
            CargarConfigPolizas();
            

        }
        private void OcultarConceptoGlobal(bool vis)
        {
            label12.Visible = vis;
            cmbcargo7.Visible = vis;
            cmbcargo8.Visible = vis;
            txtCargo7.Visible = vis;
            txtCargo8.Visible = vis;
        }
        ...
        {
            string selectedText = cmbcargo1.Text;

            // Lista de ComboBoxes
            ComboBox[] comboBoxes = { cmbcargo2, cmbcargo3, cmbcargo4, cmbcargo5 };
            

            //ComboBox comboBox = (ComboBox)sender;
            //string selectedItem = comboBox.SelectedItem.ToString();

            //// Eliminar el ítem seleccionado de la lista de ítems disponibles
            //itemsDisponibles.Remove(selectedItem);

            //// Actualizar los otros ComboBoxes con los ítems disponibles
            //foreach (Control control in pnCargos.Controls)
            //{
            //    if (control is ComboBox && control != comboBox)
            //    {
            //        ComboBox comboBoxControl = (ComboBox)control; // Convierte el control a ComboBox
            //        comboBoxControl.Items.Clear();
            //        comboBoxControl.Items.AddRange(itemsDisponibles.ToArray());
            //    }
            //}
            ...
            foreach (ComboBox comboBox in comboBoxes)
            {
                ...
                comboBox.Items.Remove(selectedText);
            }
        ...
        {
            string selectedText = cmbcargo2.Text;

            // Lista de ComboBoxes
            ComboBox[] comboBoxes = { cmbcargo1, cmbcargo3, cmbcargo4, cmbcargo5 };
            //ComboBox comboBox = (ComboBox)sender;
            //string selectedItem = comboBox.SelectedItem.ToString();
        ...
        {
            string selectedText = cmbcargo3.Text;

            // Lista de ComboBoxes
            ComboBox[] comboBoxes = { cmbcargo2, cmbcargo1, cmbcargo4, cmbcargo5 };
            //ComboBox comboBox = (ComboBox)sender;
            //string selectedItem = comboBox.SelectedItem.ToString();
        ...
        {
            string selectedText = cmbcargo4.Text;

            // Lista de ComboBoxes
            ComboBox[] comboBoxes = { cmbcargo2, cmbcargo3, cmbcargo1, cmbcargo5 };
            foreach (ComboBox comboBox in comboBoxes)
            {
                // Eliminar el elemento seleccionado
                comboBox.Items.Remove(selectedText);
        ...
        {
            string selectedText = cmbabono1.Text;
            ComboBox[] comboBoxes = { cmbabono2, cmbabono3, cmbabono4};
            foreach (ComboBox comboBox in comboBoxes)
            {
                // Eliminar el elemento seleccionado
                comboBox.Items.Remove(selectedText);
            ...
            //// Actualizar los otros ComboBoxes con los ítems disponibles
            //foreach (Control control in pnAbonos.Controls)
            //{
            //    if (control is ComboBox && control != comboBox)
            //    {
            //        ComboBox comboBoxControl = (ComboBox)control; // Convierte el control a ComboBox
            ...
            else if (cmbabono1.Text == "Catalogo Gastos")
            {
        ...
        {
            string selectedText = cmbabono2.Text;
            ComboBox[] comboBoxes = { cmbabono1, cmbabono3, cmbabono4 };
            foreach (ComboBox comboBox in comboBoxes)
            {
                // Eliminar el elemento seleccionado
                comboBox.Items.Remove(selectedText);
            ...
            else if (cmbabono2.Text == "Catalogo Gastos")
            {
        ...
        {
            string selectedText = cmbabono3.Text;
            ComboBox[] comboBoxes = { cmbabono2, cmbabono1, cmbabono4 };
            foreach (ComboBox comboBox in comboBoxes)
            {
                // Eliminar el elemento seleccionado
                comboBox.Items.Remove(selectedText);
            ...
            else if (cmbabono3.Text == "Catalogo Gastos")
            {
                cmbabono2.Items.Remove("Catalogo Gastos");
                cmbabono1.Items.Remove("Catalogo Gastos");
                cmbabono4.Items.Remove("Catalogo Gastos");
        ...
        {
            string selectedText = cmbabono4.Text;
            ComboBox[] comboBoxes = { cmbabono2, cmbabono3, cmbabono1 };
            foreach (ComboBox comboBox in comboBoxes)
            {
                // Eliminar el elemento seleccionado
                comboBox.Items.Remove(selectedText);
            ...
            else if (cmbabono4.Text == "Catalogo Gastos")
            {
                cmbabono2.Items.Remove("Catalogo Gastos");
                cmbabono3.Items.Remove("Catalogo Gastos");
                cmbabono1.Items.Remove("Catalogo Gastos");
        ...
        private void txtCargo1_KeyDown(object sender, KeyEventArgs e)
        {
            c.Catalogo_cargosyabonos3(txtCargo1.Text, cmbcargo1);
        }
        ...
        {
            // Comprobar si groupBox1 está visible y cambiar su estado
            groupBox1.Visible = !groupBox1.Visible;
            groupBox2.Enabled = groupBox1.Visible;

            // Realizar la consulta basada en el tipo de poliza
            if (TipoPolz == "Definiciones Condominios")
            {
            ...
            }else if (TipoPolz == "Definiciones Inventarios")
            {
                if(groupBox1.Visible)
                    c.Consultar_DefinicionesPolizaInv(dataGridView1);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (cmbcargo6.Text != "" || cmbcargo6.Text != string.Empty)
                {
                    if (cmbcargo1.Text == "Cuenta Contable Fija")

                    {
                        cmbcargo1.Text = cmbcargo6.Text;
                    }
                    else if (cmbcargo2.Text == "Cuenta Contable Fija")
                    {
                        cmbcargo2.Text = cmbcargo6.Text;
                    }
                    else if (cmbcargo3.Text == "Cuenta Contable Fija")
                    {
                        cmbcargo3.Text = cmbcargo6.Text;
                    }
                    else if (cmbcargo4.Text == "Cuenta Contable Fija")
                    {
                        cmbcargo4.Text = cmbcargo6.Text;
                    }
                    else if (cmbcargo5.Text == "Cuenta Contable Fija")
                    {
                        cmbcargo5.Text = cmbcargo6.Text;
                    }


                }
                if (cmbabono5.Text != "" || cmbabono5.Text != string.Empty)
                {
                    if (cmbabono1.Text == "Cuenta Contable Fija")
                    {

                        cmbabono1.Text = cmbabono5.Text;
                    }
                    else if (cmbabono2.Text == "Cuenta Contable Fija")
                    {
                        cmbabono2.Text = cmbabono5.Text;
                    }
                    else if (cmbabono3.Text == "Cuenta Contable Fija")
                    {
                        cmbabono3.Text = cmbabono5.Text;
                    }
                    else if (cmbabono4.Text == "Cuenta Contable Fija")
                    {
                        cmbabono4.Text = cmbabono5.Text;
                    }
                }


                c.EditarDefPoliza(cmbclave.Text, txtnombre.Text, cmbestatus.Text, txtseparador.Text, textBox10.Text, cmbTpoliza.Text, txtDpoliza.Text, txtCargo1.Text, cmbcargo1.Text, txtCargo2.Text, cmbcargo2.Text, txtCargo3.Text, cmbcargo3.Text, txtCargo4.Text, cmbcargo4.Text, txtCargo5.Text, cmbcargo5.Text, txtCargo7.Text, cmbcargo7.Text, txtCargo8.Text, cmbcargo8.Text, txtAbono1.Text, cmbabono1.Text, txtAbono2.Text, cmbabono2.Text, txtAbono3.Text, cmbabono3.Text, txtAbono4.Text, cmbabono4.Text, rdtNotas.Text, lblconsecutivo.Text, TipoPolz);
        ...
        private void txtnombre_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (txtnombre.Text == "Define Póliza Compras Almacén"  || txtnombre.Text == "Define Póliza Compras Gastos")
            {
                OcultarConceptoGlobal(true);
                cmbcargo1.Items.Remove("Cuenta Contable Movimientos Inventarios");
                cmbcargo2.Items.Remove("Cuenta Contable Movimientos Inventarios");
                cmbcargo3.Items.Remove("Cuenta Contable Movimientos Inventarios");
                cmbcargo4.Items.Remove("Cuenta Contable Movimientos Inventarios");
            ...
            if(txtnombre.Text == "Define Póliza Anticipos Proveedores")
            {
                OcultarConceptoGlobal(false);
                cmbcargo1.Items.Remove("Cuenta Contable Documento");
                cmbcargo2.Items.Remove("Cuenta Contable Documento");
                cmbcargo3.Items.Remove("Cuenta Contable Documento");
                cmbcargo4.Items.Remove("Cuenta Contable Documento");
            ...
            if (txtnombre.Text == "Define Póliza Aplicación Anticipos Proveedores")
            {
                cmbcargo1.Items.Remove("Cuenta Contable Documento");
                cmbcargo2.Items.Remove("Cuenta Contable Documento");
                cmbcargo3.Items.Remove("Cuenta Contable Documento");
            ...
            if(txtnombre.Text == "Define Póliza Egresos")
            {
                OcultarConceptoGlobal(false);
            }
            if (txtnombre.Text == "Define Póliza Entradas Inventariables" || txtnombre.Text == "Define Póliza Traspasos Inventariables")
            {
                cmbcargo1.Items.Remove("Centro de Costos");
                cmbcargo2.Items.Remove("Centro de Costos");
                cmbcargo3.Items.Remove("Centro de Costos");
                cmbcargo4.Items.Remove("Centro de Costos");
                cmbcargo5.Items.Remove("Centro de Costos");

                cmbabono1.Items.Remove("Centro de Costos");
                cmbabono2.Items.Remove("Centro de Costos");
                cmbabono3.Items.Remove("Centro de Costos");
                cmbabono4.Items.Remove("Centro de Costos");
        ...
        private void cmbcargo7_SelectedIndexChanged(object sender, EventArgs e)
        {
            string cb = cmbcargo7.Text;

            c.Catalogo_cargosyabonos2(cb, txtCargo7);
            if (cmbcargo7.Text == "Cuenta Contable Fija")
            {
                cmbcargo7.BackColor = Color.Red;
                MessageBox.Show("indique en el siguiente campo la cuenta contable a registrar");
                cmbcargo6.Visible = true;
            }
            else
            {
                cmbcargo7.BackColor = Color.White;
                cmbcargo6.Visible = false;
            }
            if (cmbcargo7.Text == "Cuenta Contable Fija")
            {
                cmbcargo8.Items.Remove("Cuenta Contable Fija");


            }
            else if (cmbcargo7.Text == "Cuenta Contable Conceptos Globales")
            {
                cmbcargo8.Items.Remove("Cuenta Contable Conceptos Globales");

            }
        }

        private void cmbcargo8_SelectedIndexChanged(object sender, EventArgs e)
        {
            string cb = cmbcargo8.Text;

            c.Catalogo_cargosyabonos2(cb, txtCargo8);
            if (cmbcargo8.Text == "Cuenta Contable Fija")
            {
                cmbcargo8.BackColor = Color.Red;
                MessageBox.Show("indique en el siguiente campo la cuenta contable a registrar");
                cmbcargo6.Visible = true;
            }
            else
            {
                cmbcargo8.BackColor = Color.White;
                cmbcargo6.Visible = false;
            }
            if (cmbcargo8.Text == "Cuenta Contable Fija")
            {
                cmbcargo7.Items.Remove("Cuenta Contable Fija");


            }
            else if (cmbcargo8.Text == "Cuenta Contable Conceptos Globales")
            {
                cmbcargo7.Items.Remove("Cuenta Contable Conceptos Globales");
        ...
        private void guna2ControlBox1_Click(object sender, EventArgs e)
        {
            ...
            /*  if (CuentasPersonales == "Si")
              {
                  this.Close();
                  MenuPrincipal.Panel_A_mostrar = "Antes";
                  MenuPrincipal.Panel_A_mostrar2 = "CuentasPersonalesPolizas";
              }
              else
              {*/
            this.Close();
            ...
            //MenuPrincipal.Panel_A_mostrar = "Antes";
            //MenuPrincipal.Panel_A_mostrar2 = "CPCondominiosPolizas";
            //}
        ...
        private void pnAbonos_Paint(object sender, PaintEventArgs e)
        {
