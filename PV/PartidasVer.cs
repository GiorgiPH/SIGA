...
namespace ControlAcademico
{
    public partial class PartidasVer : Form
    {
        ...
        private void PartidasVer_Load(object sender, EventArgs e)
        {
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                c.ConsultaPartida(TxtFolio.Text, Partida,  txtClaveConcepto, txtConcepto, txtConcepto2,  txtCantidad,  txtUnidad,  txtDivisa,  txtTipoCambio,  txtSubtotal,  txtDescuento,  txtTotal);
